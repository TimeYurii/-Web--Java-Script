...
function triangle(value1, type1, value2, type2) {
    ...
    switch (true) {
        case type1 === "leg" && type2 === "leg":
            ...
            beta = 90 - alpha;
            break;
        case (type1 === "leg" && type2 === "hypotenuse") || (type1 === "hypotenuse" && type2 === "leg"):
            ...
            beta = 90 - alpha;
            break;
        case (type1 === "leg" && type2.includes("angle")) || (type2 === "leg" && type1.includes("angle")):
            ...
            b = Math.sqrt(c ** 2 - a ** 2);
            break;
        case (type1 === "hypotenuse" && type2 === "angle") || (type2 === "hypotenuse" && type1 === "angle"):
